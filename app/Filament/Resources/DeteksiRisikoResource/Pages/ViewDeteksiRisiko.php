...
class ViewDeteksiRisiko extends ViewRecord
{
    ...
    {
        return [
            Actions\Action::make('lihat_ibu_hamil')
                ->label('Lihat Data Ibu Hamil')
                ->icon('heroicon-o-user')
                ->url(fn() => \App\Filament\Resources\IbuHamilResource::getUrl('view', ['record' => $this->record->ibu_hamil_id]))
                ->color('info'),
    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                ...
                Infolists\Components\Section::make('Data Ibu Hamil')
                    ->schema([
                        ...
                        Infolists\Components\TextEntry::make('ibuHamil.nik')
                            ->label('NIK')
                            ->copyable()
                            ->icon('heroicon-m-identification'),
                        Infolists\Components\TextEntry::make('ibuHamil.tanggal_lahir')
                            ->label('Tanggal Lahir')
                            ->date('d F Y')
                            ->icon('heroicon-m-cake'),
                        Infolists\Components\TextEntry::make('ibuHamil.alamat_lengkap')
                            ->label('Alamat')
                            ->icon('heroicon-m-map-pin')
                            ->columnSpanFull(),
                        Infolists\Components\TextEntry::make('ibuHamil.kecamatan')
                            ->label('Kecamatan')
                            ->icon('heroicon-m-map'),
                        Infolists\Components\TextEntry::make('ibuHamil.no_telp')
                            ->label('No. WhatsApp')
                ...
                Infolists\Components\Section::make('Rekomendasi')
                    ...
                    ->collapsed(false)
                    ->headerActions([
                        Infolists\Components\Actions\Action::make('cetak_rekomendasi')
                            ->label('Cetak Rekomendasi')
                            ->icon('heroicon-o-printer')
                            ->color('success')
                            ->action(function () {
                                // Action untuk cetak akan ditambahkan nanti
                            }),
                    ]),
